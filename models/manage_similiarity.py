...
'''
client = MongoClient(f"mongodb+srv://{os.environ.get('USER')}:<{os.environ.get('PASSWORD')}>@mymongo.otbi0bn.mongodb.net/?retryWrites=true&w=majority", os.environ.get('PORT'))
